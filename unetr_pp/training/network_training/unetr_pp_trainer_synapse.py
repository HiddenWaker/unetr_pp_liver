...
class unetr_pp_trainer_synapse(Trainer_synapse):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if self.deep_supervision:
                ...
                print("weights:",weights) # [0.57142857 0.28571429 0.14285714]
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            ...
            del data
            #print("#########################################")
            #print(output) # length 3
            #print(output[0].shape) # torch.Size([2, 2, 64, 128, 128])
            #print(len(target)) # 3
            #print(target[0].unique())
            l = self.loss(output, target) # AsymmetricUnifiedFocalLoss
            #print("Unified focal loss:",l)
