...
from unetr_pp.training.loss_functions.dice_loss import DC_and_CE_loss, DC_and_FCE_loss #, #DC_and_FC_loss
...
class Trainer_synapse(NetworkTrainer_synapse):
    ...
    def run_online_evaluation(self, output, target):
        with torch.no_grad():
            ...
            output_seg = output_softmax.argmax(1) # axis=1에 대해서 argmax?
            target = target[:, 0]
