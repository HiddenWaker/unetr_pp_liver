...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.unetr_pp_encoder_hessian = UnetrPPEncoder(dims=dims, depths=depths, num_heads=num_heads) # adding 10/3
    ...
    def forward(self, x_in):
        ...
        x_hessian_in = self.hessian_matrix(x_in)
        x_output_hessian, hidden_states_hessian = self.unetr_pp_encoder_hessian(x_hessian_in)
        ...
        enc1_hessian = hidden_states_hessian[0]
        enc2_hessian = hidden_states_hessian[1]
        enc3_hessian = hidden_states_hessian[2]
        enc4_hessian = hidden_states_hessian[3]
        
        # 10/3 adding
        # Add hessian encoder and encoder
        enc1 = enc1 + enc1_hessian
        enc2 = enc2 + enc2_hessian
        enc3 = enc3 + enc3_hessian
        enc4 = enc4 + enc4_hessian
